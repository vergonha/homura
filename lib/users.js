...
export default class Users {
    ...
    */ 
    ...
    getFriends = async(user, recenttracks, limit) => {
        let _URL = `${this.attributes.baseURL}/2.0/?method=user.getFriends&api_key=${this.attributes.apiKey}&format=json`
        _URL += `&user=${user}`
    ...
    */ 
    ...
    getInfo = async(user) => {
        let _URL = `${this.attributes.baseURL}/2.0/?method=user.getInfo&api_key=${this.attributes.apiKey}&format=json`
        _URL += `&user=${user}`
    ...
    */ 
    ...
    getLovedTracks = async(user, limit, page) => {
        let _URL = `${this.attributes.baseURL}/2.0/?method=user.getLovedTracks&api_key=${this.attributes.apiKey}&format=json`
        _URL += `&user=${user}`
        if(limit){_URL += `&limit=${limit}`}
    ...
    */ 
    ...
    getRecentTracks = async(user, limit, page, from, to, extended) => {
        let _URL = `${this.attributes.baseURL}/2.0/?method=user.getRecentTracks&api_key=${this.attributes.apiKey}&nowplaying=1&format=json`
        _URL += `&user=${user}`
        if(limit){_URL += `&limit=${limit}`}
        if(page){_URL += `&page=${page}`}
    ...
    */ 
    ...
    getTopAlbums = async(user, period, limit, page) => {
        let _URL = `${this.attributes.baseURL}/2.0/?method=user.gettopalbums&api_key=${this.attributes.apiKey}&format=json`
        _URL += `&user=${user}`
    ...
    */ 
    ...
    getTopTracks = async(user, period, limit, page) => {
        let _URL = `${this.attributes.baseURL}/2.0/?method=user.getTopTracks&api_key=${this.attributes.apiKey}&format=json`
        _URL += `&user=${user}`
        if(period){_URL += `&period=${period}`}
        if(limit){_URL += `&limit=${limit}`}
        if(page){_URL += `&page=${page}`}
